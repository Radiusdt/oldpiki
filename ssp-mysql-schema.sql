...
CREATE TABLE IF NOT EXISTS `gtid_executed` (
  `source_uuid` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'uuid of the source where the transaction was originally executed.',
  `interval_start` bigint NOT NULL COMMENT 'First number of interval.',
  `interval_end` bigint NOT NULL COMMENT 'Last number of interval.',
  `gtid_tag` char(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'GTID Tag.',
  PRIMARY KEY (`source_uuid`,`gtid_tag`,`interval_start`)
) /*!50100 TABLESPACE `mysql` */ ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci STATS_PERSISTENT=0 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `application` (
  ...
  `store_type` tinyint DEFAULT NULL,
  `store_data` json DEFAULT NULL,
  `status` tinyint NOT NULL DEFAULT '0',
  `install_costs` json DEFAULT NULL,
  `install_costs_currency_id` int DEFAULT NULL,
...
CREATE TABLE `campaign` (
  ...
  `subid1` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `subid2` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `subid3` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `subid4` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `subid5` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `offer_cap` int unsigned DEFAULT NULL,
  `offer_cap_reach` int unsigned NOT NULL DEFAULT '0',
  `payout_amount` float DEFAULT NULL,
  `payout_currency_id` int DEFAULT NULL,
  `payout_type` tinyint(1) DEFAULT NULL,
  `comment` text COLLATE utf8mb4_unicode_ci,
  `status` tinyint NOT NULL DEFAULT '0',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
  `payout_event_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `campaign_key` (`key`),
...
--
-- Table structure for table `event_temporary`
--

DROP TABLE IF EXISTS `event_temporary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `event_temporary` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14987 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `geo_city` (
  ...
  `name_ru` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_en` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `country_id` (`country_id`),
  KEY `region_id` (`region_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9000003 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `geo_region` (
  ...
  PRIMARY KEY (`id`),
  KEY `country_id` (`country_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8604685 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `internet_service_provider` (
  ...
  `mnc` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country_id` int DEFAULT NULL,
  `country_iso` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mobile_brand` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mobile_operator_id` int DEFAULT NULL,
  `domain` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_mobile` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `isp_unique` (`country_id`,`isp`,`mobile_brand`),
...
CREATE TABLE `mobile_operator` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq` (`name`,`country_iso`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `offer` (
  ...
  `url_forward` text COLLATE utf8mb4_unicode_ci,
  `status` int DEFAULT '1',
  `image_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country_ids` json DEFAULT NULL,
  `payment_amount` float DEFAULT NULL,
  `payment_currency_id` int DEFAULT NULL,
  `payment_event_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `source` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `internal_name` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `detect_by_param` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `detect_by_param_value` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint NOT NULL DEFAULT '0',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `track_temporary`
--

DROP TABLE IF EXISTS `track_temporary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `track_temporary` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=126617 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  `login` varchar(20) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  ...
  `status_moderation` smallint NOT NULL DEFAULT '0',
  `created_at` int DEFAULT NULL,
  `updated_at` int DEFAULT NULL,
...
CREATE TABLE `user_token` (
  ...
  `created_at` int DEFAULT NULL,
  `updated_at` int DEFAULT NULL,
  `is_latest_in_use` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `is_latest_in_use` (`is_latest_in_use`),
...
-- Dump completed on 2025-11-30 15:48:47
